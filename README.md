...
3. I had to determine my best course of action regarding building out the project. Major components to think about:
    - Light and dark mode
    - Styling
    - Functionality 
        - Create a new todo
...
6. I decided to switch from Tailwind CSS to Chakra UI to speed up the process.
